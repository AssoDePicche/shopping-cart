...
final class CartTest extends TestCase
{
  ...
  {
    $product1 = new Product('Book', 29.99, 6);

    $product2 = new Product('Book', 29.99, 6);
  ...
  public function test_remove_amount_smaller_than_one_should_throw_invalid_argument_exception(): void
  {
    ...
    $product = new Product('Book', 29.99, 6);
  ...
  public function test_clear_should_remove_all_items_from_cart(): void
  {
    ...
    $product2 = new Product('Graphic Novel', 19.99, 20);
  ...
  {
    $product1 = new Product('Book', 16, 5);

    $product2 = new Product('Graphic Novel', 16, 5);
  ...
  public function test_get_size_should_return_the_quantity_of_all_items(): void
  {
    ...
    $product2 = new Product('Graphic Novel', 29.99, 6);
